class InterestsController < ApplicationController
  ...
  # POST /interests.xml
  def create
    @interest = Interest.new(params[:interest].merge(:user => current_user))

    respond_to do |format|
      if @interest.save
        flash[:notice] = 'Your interest has been noted. <a href="/interests/' + @interest.id.to_s + '/edit">add detail.</a>'
